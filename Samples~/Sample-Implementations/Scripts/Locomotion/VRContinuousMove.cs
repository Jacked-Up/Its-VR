...
namespace ItsVR_Samples.Locomotion {
    ...
    public class VRContinuousMove : MonoBehaviour {
        ...
        private void MoveUpdate() {
            ...
            var joystickInputPosition = inputController.inputReference.JoystickPosition;
            ...
            var movementSpeed = inputController.inputReference.JoystickPressed ? sprintSpeed : walkingSpeed;
