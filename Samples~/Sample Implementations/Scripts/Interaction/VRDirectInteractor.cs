...
namespace ItsVR_Samples.Interaction {
    ...
    [AddComponentMenu("It's VR/Samples/Interaction/Direct Interactor (Sample) (Incomplete)")]
    public class VRDirectInteractor : VRInteractor {
        ...
        private void OnEnable() {
            if (connectedController == null) 
                ...
                connectedController.inputReference.universalInputs.gripPressed.Enable();
                connectedController.inputReference.universalInputs.gripPressed.performed += AttemptGrab;
            }
        }
